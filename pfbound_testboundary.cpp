...
bool isOnBoundary(int *a)
{
    ...
    if (abs(v1 - v2) > 8)
    {
        // std::cout << "3CONDITIONTRUE" << std::endl;
        return true;
    }
...
int main(int argc, char *argv[])
{
    ...
    //
    // if        (bchoice == 1){
    // B = findBorderCellsByVecSum(M, 200, 55);
    // } else if (bchoice == 2){
    // B = findBorderCellsByFOV(M, 170, 2);
    // } else if (bchoice == 3){
    // B = findBorderCellsByQuadrantEmpty(M, 200);
    // } else if (bchoice == 4){
    // B = findBorderCellsByLevine(M, 200);
    // } else if (bchoice == 5){
    // B = findBorderCellsByEdgeScan(M, 140);
    // } else {
